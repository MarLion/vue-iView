  ...
  <div class="upload-container" :style="{width:this.conWidth}">
    <div class="divs">
      ...
      <div class="add-image mt10">
        ...
        <modal title="查看视频" v-model="visible" @on-visible-change="reVideoVisible">
...
<script>
  ...
  export default {
    ...
    watch:{  //通过监听watchValue值得变化来决定是否加载原有视频
      watchValue(value){
        if (value) {
          this.$refs.upload.fileList = this.defaultList;
          this.uploadList = this.$refs.upload.fileList;
